              ...
              for (v(a).lastIndex = 0; (n = v(a).exec(t)); ) {
                ...
                if (c) {
                  var h = v(a).lastIndex,
                    m = P(n.index, a);
                  (v(a).lastIndex = h),
                    (p = l.slice(0, l.indexOf(m.nextMatch[0])));
                    ...
                    case "checkval":
                      ...
                      if (i.enforceDigitsOnBlur) {
                        ...
                        (o.refreshFromBuffer = !0),
                          (o.buffer = c(m, i.digits, i, !0).reverse());
                      }
                  }
                return o;
              },
                ...
                if (d) k();
                  ...
                  switch (r.charAt(0)) {
                    ...
                    case a.quantifiermarker[0]:
                      ...
                      ("*" !== M && "+" !== M) || (M = "*" === _ ? 0 : 1),
                        (E.quantifier = { min: M, max: _, jit: O });
                      var T =
                  ...
                  default:
                    ...
                    if (d <= h)
                      ...
                      if (
                        ...
                        (!s.call(n, h, c.keepStatic, !0) && v.match.def === g)
                      ) {
                        var k = l.call(n, h);
                        (d >= k || d === h) && (h = k);
                      }
            ...
            function g(t, a, n, r) {
              function o(n, r, f) {
                ...
                if (d === e && void 0 === n.matches)
                  return (
                    h.push({ match: n, locator: r.reverse(), cd: v, mloc: {} }),
                    !0
                  );
                if (void 0 !== n.matches) {
                  if (n.isGroup && f !== n) {
                    ...
                    if (-1 === T || "string" == typeof T) {
                      ...
                      for (var F = 0; F < B.length; F++) {
                        (A = parseInt(B[F])),
                          (h = []),
                          (a =
                            ("string" == typeof T && k(d, A, _)) || D.slice());
                        var N = S.matches[A];
                          ...
                          for (var K = 0; K < w.length; K++) {
                            ...
                            if (
                              ...
                              if (
                                ...
                                !0 === (Q = G).match.static &&
                                  !0 !== W.match.static &&
                                  W.match.fn.test(Q.match.def, s, e, !1, u, !1))
                              ) {
                                b(G, U) ||
                    ...
                    for (
                      var $ = n, q = a.length > 0 ? a.shift() : 0;
                      q <
                        (isNaN($.quantifier.max) ? q + 1 : $.quantifier.max) &&
                      d <= e;
                      q++
                    ) {
        ...
        7215: function (e, t, a) {
          ...
          function l(e, t, a, i, r, s) {
            ...
            if (void 0 !== c) {
              ...
              for (
                ...
                for (
                  S.tests = {}, o.resetMaskSet.call(x, !0), _ = !0, h = 0;
                  h < A.length &&
                  ((g =
                    _.caret || o.getLastValidPosition.call(x, void 0, !0) + 1),
                  (k = A[h]),
                  (_ = f.call(x, g, k, !1, i, !0)));
                  h++
                )
                  h === C && (O = _), 1 == e && _ && (O = { caretPos: h });
                if (_) break;
                if (
                ...
                for (
                  S.excludes[v].push(D + ":" + p.alternation), h = v;
                  h < o.getLastValidPosition.call(x, void 0, !0) + 1;
                  h++
                )
                  delete S.validPositions[h];
          ...
          function f(e, t, a, i, r, s, d) {
                  ...
                  if (
                    ...
                    !1 !==
                      (s =
                        (!f.jit ||
                          void 0 !==
                            y.validPositions[o.seekPrevious.call(v, t)]) &&
                        (null != f.fn
                    ...
                    return (
                      (d =
                        d === k.skipOptionalPartCharacter && !0 === f.static
                          ? n.getPlaceholder.call(v, t, f, !0) || f.def
                          : d),
                      !0 !== (s = P(s)) &&
                        void 0 !== s.pos &&
                        s.pos !== t &&
                      ...
                      !0 !== s && void 0 === s.pos && void 0 === s.c
                        ...
                        : (!1 ===
                            m.call(
                              v,
                              e,
                              g.extend({}, l, { input: u.call(v, d, f, p) }),
                              i,
                              p
                            ) && (s = !1),
                          !1)
            ...
            if (
              ...
              for (var M = x; M < (v.isRTL ? e.begin : e.end); M++)
                void 0 !== y.excludes[M] &&
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  if (
                    k.insertMode ||
                    void 0 === y.validPositions[o.seekNext.call(v, x)] ||
                    e.end > x
                  ) {
                    var O = !1;
                    if (
                      (y.jitOffset[x] &&
                        void 0 === y.validPositions[o.seekNext.call(v, x)] &&
                        !1 !== (S = f.call(v, x + y.jitOffset[x], t, !0, !0)) &&
                        (!0 !== r && (S.caret = x), (O = !0)),
                      e.end > x && (y.validPositions[x] = void 0),
                      !O && !o.isMask.call(v, x, k.keepStatic && 0 === x))
                    )
                      for (
                        var T = x + 1, A = o.seekNext.call(v, x, !1, 0 !== x);
                        T <= A;
                        T++
                      )
                        if (!1 !== (S = E(T, t, a))) {
                          (S = h.call(v, x, void 0 !== S.pos ? S.pos : T) || S),
                            (x = T);
                          break;
                        }
                  }
